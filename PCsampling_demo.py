...
import sampling_kt_sake
from likelihood import get_likelihood_fn
from sde_lib import VESDE, VPSDE, subVPSDE
from sampling_kt_sake import (ReverseDiffusionPredictor, 
                      LangevinCorrector, 
...
if sde.lower() == 'vesde':
  ...
  ########################################################################
  # ckpt_filename_xt = '/home/lqg/桌面/kt-ncsn/ncsnpp_x_f/score_sde_pytorch_x_f/exp/checkpoints/checkpoint_61.pth'
  ckpt_filename_xt = '/home/lqg/桌面/kt-ncsn/ncsnpp_x_f/score_sde_pytorch_x_f/exp/checkpoints/checkpoint_61.pth'
  ckpt_filename_kt = '/home/lqg/桌面/kt-ncsn/ncsnpp_k_t/score_sde_pytorch_k_t/exp/checkpoints/checkpoint_80.pth'
  ########################################################################
...
########################################################################
sampling_fn = sampling_kt_sake.get_pc_sampler(sde, shape, predictor, corrector,
